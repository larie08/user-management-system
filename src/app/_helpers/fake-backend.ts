            ...
            if (accounts.find(x => x.email === account.email)) {
                ...
                setTimeout(() => { 
                    alertService.info(`
                        ...
                        <p>If you don't know your password please visit the <a href="${location.origin}/account/forget-password">forgot password</a> page.</p> 
        ...
        function forgotPassword() {
            ...
            setTimeout(() => { 
                ...
                alertService.info(` 
                    ...
                    div><strong>NOTE:</strong> The fake backend displayed this "email" so you can test without an api. A real backend would send a real enail.</div> 
                `, { autoClose: false }); 
            }, 1000); 
